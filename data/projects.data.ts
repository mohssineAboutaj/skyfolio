...
const projects: Project[] = [
  ...
  },
  {
    ...
    platforms: [],
    description:
      "REST API for creating and storing short-to-long URL mappings, including URL validation and MongoDB persistence.",
    imgs: ["/images/projects/url-shortener-service/image.png"],
    visible: true,
    featured: false,
    types: [categories.webapp],
    tech: [
